...
openai.api_key = "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"
    ...
    if request.method == 'POST':
        ...
        if img_form.is_valid():
            ...
            textract_client = boto3.client('textract',
                aws_access_key_id='AKIATU4GQIFA5OXMMAV7',
                aws_secret_access_key='wwI4Om3LlJKLLnMXVlIFP8gCeG2iB374IxyZ',

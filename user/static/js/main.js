window.addEventListener('load',function(){
    ...
    tl.fromTo("#title",{opacity:0,y:25},{opacity:1,duration:0.7,y:0},"-=0.9")    
    tl.fromTo("#description",{opacity:0,y:25},{opacity:1,duration:0.6,y:0},"-=0.4")    
    tl.fromTo("#image",{opacity:0,y:25},{opacity:1,duration:0.6,y:0},"-=0.2")    
...
gsap.fromTo("#cont3_p1",{opacity:0,x:-30}, {
    scrollTrigger: {
    trigger: "#cont3",
    start: "36% 90%", 
...
gsap.fromTo("#cont3_p2",{opacity:0,x:30}, {
    scrollTrigger: {
    trigger: "#cont3",
    start: "56% 90%", 
...
gsap.fromTo("#cont4_p1",{opacity:0,x:-30}, {
    scrollTrigger: {
    trigger: "#cont4",
    start: "76% 90%", 
...
gsap.fromTo("#cont4_p2",{opacity:0,x:30}, {
    scrollTrigger: {
    trigger: "#cont4",
    start: "76% 90%", 
